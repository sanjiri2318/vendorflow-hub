...
export const IMPORT_MODULES: ImportModule[] = [
  {
    ...
    fields: [
      ...
      { key: 'portal', label: 'Portal/Channel', required: true, type: 'select', options: ['Amazon', 'Flipkart', 'Meesho', 'Myntra', 'Own Website'] },
      ...
      { key: 'total_amount', label: 'Total Amount (₹)', required: true, type: 'number', validate: v => v <= 0 ? 'Amount must be positive' : null },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'net_amount', label: 'Net Amount (₹)', required: true, type: 'number' },
