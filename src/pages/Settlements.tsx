          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <Select value={statusFilter} onValueChange={setStatusFilter}>
              ...
              <SelectContent>
                ...
                {Object.entries(settlementStatusConfig).map(([key, config]) => (
            ...
            <Table>
              ...
              <TableBody>
                {filteredSettlements.map((settlement) => {
                  ...
                  return (
                    <TableRow key={settlement.settlementId} className="hover:bg-muted/30">
                      ...
                      <TableCell className="text-sm">
                        {formatDate(settlement.cycleStart)} - {formatDate(settlement.cycleEnd)}
                      </TableCell>
                      ...
                      <TableCell className="text-center">
                        <Badge variant="secondary">{settlement.ordersCount}</Badge>
                      </TableCell>
