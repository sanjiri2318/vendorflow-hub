...
export default function ProductHealth() {
  ...
  const liveCount = mockProductHealth.filter(p => 
    Object.values(p.portalStatus).every(s => s === 'live')
  ).length;
  ...
  const notActiveCount = mockProductHealth.filter(p => 
    Object.values(p.portalStatus).every(s => s === 'not_active')
  ).length;
          ...
          <CardContent className="pt-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Partially Live</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Has OOS</p>
              </div>
            </div>
          </CardContent>
        </Card>
